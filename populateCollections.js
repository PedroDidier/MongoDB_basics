...
db.Cidades.insertOne({
  ...
  pontos: [
    ...
    db.PontosTuristicos.findOne({ nome: "Igreja Nossa Senhora dos Aflitos" })
      ._id,
  ...
  guias: [
    {
      nome: "Pedro Didier",
      CPF: "123.456.789-10",
      dataContratacao: new Date("2021-01-12"),
    },
    {
      nome: "Pedro Tenorio",
      CPF: "692.469.234-52",
      dataContratacao: new Date("2020-07-14"),
    },
    {
      nome: "Daniel Pacheco",
      CPF: "111.111.111-11",
      dataContratacao: new Date("2019-12-12"),
    },
  ],
  itens: [
  ...
  guias: [
    {
      nome: "G",
      CPF: "222.222.222-22",
      dataContratacao: new Date("2020-02-02"),
    },
    {
      nome: "Heitor Coimbra",
      CPF: "111.456.789-10",
      dataContratacao: new Date("2021-09-22"),
    },
    {
      nome: "Charles Gabriel",
      CPF: "696.362.234-12",
      dataContratacao: new Date("2020-01-14"),
    },
    {
      nome: "Nilo Tubarino",
      CPF: "333.333.333-33",
      dataContratacao: new Date("2019-11-19"),
    },
    {
      nome: "Gustavo Chaves",
      CPF: "444.444.444-44",
      dataContratacao: new Date("2022-02-02"),
    },
  ],
  itens: [
